...
/**
 * RetiroId generated by hbm2java
 */
public class RetiroId  implements java.io.Serializable {
    ...
    public RetiroId(String codCia, long codActivo) {
       this.codCia = codCia;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof RetiroId) ) return false;
		 RetiroId castOther = ( RetiroId ) other; 
